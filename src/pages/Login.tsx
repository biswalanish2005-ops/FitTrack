  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 relative">
      <motion.div 
        ...
        className="glass-card p-10 bg-white dark:bg-[#1A1A1A] border border-black/5 dark:border-white/5 w-full max-w-md shadow-2xl relative overflow-hidden"
      >
        <div className="absolute top-0 right-0 w-32 h-32 bg-accent/10 rounded-full blur-3xl -mr-16 -mt-16 pointer-events-none" />
        <div className="absolute bottom-0 left-0 w-32 h-32 bg-primary/5 dark:bg-white/5 rounded-full blur-3xl -ml-16 -mb-16 pointer-events-none" />
        ...
        <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
           ...
           <div className="relative py-2">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                 <span className="bg-white dark:bg-[#1A1A1A] px-3 text-slate-400 font-bold tracking-wider">Or continue with</span>
              </div>
           </div>
        ...
        <div className="mt-8 text-center text-sm relative z-10">
           ...
           <NavLink to="/register" className="text-accent font-bold hover:underline">Sign up for free</NavLink>
        </div>
      </motion.div>
    </div>
  );
